...
st.sidebar.markdown("This is a two-step process:")
st.sidebar.text("1. Upload the image of the plant.")
st.sidebar.text("2. Then hit the Predict button.")
st.sidebar.markdown("---")

st.subheader("This is a two step process :")
st.text("1. Upload the image of the plant.")
st.text("2. Then hit the Predict button.")
